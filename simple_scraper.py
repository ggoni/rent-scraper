#!/usr/bin/env python3
"""
Portal Inmobiliario Rental Property Scraper - Simple Requests Version

This scraper uses requests and BeautifulSoup for faster execution
and lower resource usage. Good for static content.
"""
...
class SimplePortalInmobiliarioScraper:
    """Simple requests-based scraper for Portal Inmobiliario rental properties."""
    ...
    def run(self):
        ...
        try:
            self.logger.info("Starting Portal Inmobiliario scraper (Simple requests version)")
...
def main():
    ...
    scraper = SimplePortalInmobiliarioScraper()
    scraper.run()
